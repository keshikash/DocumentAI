...
# Concatenate all cropped images into a single array
...
np.save("cropped_images.npy", cropped_images)  # Save for training
...
print(f"Total cropped images: {cropped_images.shape[0]}")
